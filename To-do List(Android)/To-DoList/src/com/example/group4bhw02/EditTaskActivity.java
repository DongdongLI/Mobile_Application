...
public class EditTaskActivity extends Activity implements View.OnClickListener, View.OnTouchListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		titleEditText = (EditText) findViewById(R.id.edit_task_title_edittext);
		dateEditText = (EditText) findViewById(R.id.edit_task_date_edittext);
		timeEditText = (EditText) findViewById(R.id.edit_task_time_edittext);
		radioGroup = (RadioGroup) findViewById(R.id.edit_task_radiogroup);
		saveButton = (Button) findViewById(R.id.edit_task_save_button);
	...
	private void selectRadioButtonAtIndex() {
		switch (task.getPriority()) {
		case 1: radioGroup.check(R.id.radio_high);	break;
		case 2: radioGroup.check(R.id.radio_medium);break;
		case 3: radioGroup.check(R.id.radio_low);	break;
		}
	}
	...
	public boolean onTouch(View v, MotionEvent event) {
		if (event.getAction() == MotionEvent.ACTION_DOWN)
			switch (v.getId()) {
			case R.id.edit_task_date_edittext:
				...
				return true;
			case R.id.edit_task_time_edittext:
